...
// UpdateComponentVersionResponse is returned by UpdateComponentVersion on success.
type UpdateComponentVersionResponse struct {
	UpdateComponentVersion *UpdateComponentVersionUpdateComponentVersion `json:"updateComponentVersion"`
}

// GetUpdateComponentVersion returns UpdateComponentVersionResponse.UpdateComponentVersion, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionResponse) GetUpdateComponentVersion() *UpdateComponentVersionUpdateComponentVersion {
	return v.UpdateComponentVersion
}

// UpdateComponentVersionUpdateComponentVersion includes the requested fields of the GraphQL type ComponentVersion.
type UpdateComponentVersionUpdateComponentVersion struct {
...
// GetTypename returns UpdateComponentVersionUpdateComponentVersion.Typename, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionUpdateComponentVersion) GetTypename() string { return v.Typename }

// GetId returns UpdateComponentVersionUpdateComponentVersion.Id, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionUpdateComponentVersion) GetId() string { return v.Id }

// GetVersion returns UpdateComponentVersionUpdateComponentVersion.Version, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionUpdateComponentVersion) GetVersion() string { return v.Version }

// GetComponentId returns UpdateComponentVersionUpdateComponentVersion.ComponentId, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionUpdateComponentVersion) GetComponentId() string { return v.ComponentId }

// GetTag returns UpdateComponentVersionUpdateComponentVersion.Tag, and is useful for accessing the field via an interface.
func (v *UpdateComponentVersionUpdateComponentVersion) GetTag() string { return v.Tag }
...
// __UpdateComponentVersionInput is used internally by genqlient
type __UpdateComponentVersionInput struct {
	Id    string                 `json:"id"`
	Input *ComponentVersionInput `json:"input,omitempty"`
}

// GetId returns __UpdateComponentVersionInput.Id, and is useful for accessing the field via an interface.
func (v *__UpdateComponentVersionInput) GetId() string { return v.Id }

// GetInput returns __UpdateComponentVersionInput.Input, and is useful for accessing the field via an interface.
func (v *__UpdateComponentVersionInput) GetInput() *ComponentVersionInput { return v.Input }
...
// The mutation executed by UpdateComponentVersion.
const UpdateComponentVersion_Operation = `
mutation UpdateComponentVersion ($id: ID!, $input: ComponentVersionInput!) {
	updateComponentVersion(id: $id, input: $input) {
		__typename
		id
		version
		componentId
...
func UpdateComponentVersion(
	ctx_ context.Context,
	client_ graphql.Client,
	id string,
	input *ComponentVersionInput,
) (data_ *UpdateComponentVersionResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "UpdateComponentVersion",
		Query:  UpdateComponentVersion_Operation,
		Variables: &__UpdateComponentVersionInput{
			Id:    id,
			Input: input,
		},
	}

	data_ = &UpdateComponentVersionResponse{}
	resp_ := &graphql.Response{Data: data_}
