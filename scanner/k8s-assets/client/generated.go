...
import (
	...
	"github.com/cloudoperators/heureka/internal/api/graphql/graph/scalar"
)
...
func (v *ComponentInstanceFilter) GetComponentVersionDigest() []string {
	return v.ComponentVersionDigest
}
...
// GetPod returns ComponentInstanceFilter.Pod, and is useful for accessing the field via an interface.
func (v *ComponentInstanceFilter) GetPod() []string { return v.Pod }
...
func (v *ComponentInstanceFilter) GetContext() []scalar.Map { return v.Context }
...
func (v *ComponentInstanceFilter) UnmarshalJSON(b []byte) error {
	...
	firstPass.ComponentInstanceFilter = v
		...
		*dst = make(
		...
		for i, src := range src {
			...
			if len(src) != 0 && string(src) != "null" {
				err = scalar.UnmarshalMap(
					src, dst)
				if err != nil {
					return fmt.Errorf(
						"unable to unmarshal ComponentInstanceFilter.Context: %w", err)
				}
			}
		}
	}
...
type __premarshalComponentInstanceFilter struct {
	ComponentVersionDigest []string `json:"componentVersionDigest"`
...
func (v *ComponentInstanceFilter) MarshalJSON() ([]byte, error) {
...
func (v *ComponentInstanceFilter) __premarshalJSON() (*__premarshalComponentInstanceFilter, error) {
	var retval __premarshalComponentInstanceFilter

	retval.ComponentVersionDigest = v.ComponentVersionDigest
	retval.ServiceCcrn = v.ServiceCcrn
	retval.Ccrn = v.Ccrn
	...
	retval.Type = v.Type
	{
		...
		*dst = make(
		...
		for i, src := range src {
			dst := &(*dst)[i]
			var err error
			*dst, err = scalar.MarshalMap(
				&src)
			if err != nil {
				return nil, fmt.Errorf(
					"unable to marshal ComponentInstanceFilter.Context: %w", err)
			}
		}
	}
	retval.SupportGroup = v.SupportGroup
	retval.Search = v.Search
...
// GetPod returns ComponentInstanceInput.Pod, and is useful for accessing the field via an interface.
func (v *ComponentInstanceInput) GetPod() string { return v.Pod }
...
func (v *ComponentInstanceInput) GetContext() scalar.Map { return v.Context }
...
func (v *ComponentInstanceInput) UnmarshalJSON(b []byte) error {
	...
	firstPass.ComponentInstanceInput = v
...

	{
		...
		if len(src) != 0 && string(src) != "null" {
			...
			if err != nil {
				return fmt.Errorf(
					"unable to unmarshal ComponentInstanceInput.Context: %w", err)
			}
		}
	}
	return nil
...
type __premarshalComponentInstanceInput struct {
	Ccrn string `json:"ccrn"`
...
func (v *ComponentInstanceInput) MarshalJSON() ([]byte, error) {
	premarshaled, err := v.__premarshalJSON()
	if err != nil {
		return nil, err
	}
...
func (v *ComponentInstanceInput) __premarshalJSON() (*__premarshalComponentInstanceInput, error) {
	var retval __premarshalComponentInstanceInput

	retval.Ccrn = v.Ccrn
	retval.Count = v.Count
	retval.ComponentVersionId = v.ComponentVersionId
	retval.ServiceId = v.ServiceId
	retval.Region = v.Region
	retval.Cluster = v.Cluster
	retval.Namespace = v.Namespace
	retval.Domain = v.Domain
	...
	retval.Type = v.Type
	{
		...
		*dst, err = scalar.MarshalMap(
		...
		if err != nil {
			return nil, fmt.Errorf(
				"unable to marshal ComponentInstanceInput.Context: %w", err)
		}
	}
	retval.Uuid = v.Uuid
	return &retval, nil
