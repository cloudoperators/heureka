...
(
    ...
    componentinstance_region               varchar(2048)                         not null,
    componentinstance_cluster              varchar(2048)                         not null,
    componentinstance_namespace            varchar(2048)                         not null,
    componentinstance_domain               varchar(2048)                         not null,
    componentinstance_project              varchar(2048)                         not null,
