...
var issueVariantObject = DbObject[*entity.IssueVariant, *entity.IssueVariantFilter, entity.IssueVariantResult, *any]{
	Prefix:       "issuevariant",
	...
	NewResult: func(iv *entity.IssueVariant, _ *any, cursor string) entity.IssueVariantResult {
