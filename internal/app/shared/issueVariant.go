...
// it does take the first issue_variant with the highest priority for the respective component
// instance. This is archived by utilizing database.GetServiceIssueVariants that does return ALL
// issue variants for a given component instance id together with the priorty and afterwards
// identifying for each issue the variant with the highest
// priority
//
