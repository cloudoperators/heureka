...
func NewIssueMatchHandler(database database.Database, eventRegistry event.EventRegistry, ss severity.SeverityHandler, cache cache.Cache, authz openfga.Authorization) IssueMatchHandler {
