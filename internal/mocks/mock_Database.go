...
// GetDefaultRepositoryName provides a mock function with given fields:
func (_m *MockDatabase) GetDefaultRepositoryName() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetDefaultRepositoryName")
	}
...
// MockDatabase_GetDefaultRepositoryName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDefaultRepositoryName'
type MockDatabase_GetDefaultRepositoryName_Call struct {
	*mock.Call
}

// GetDefaultRepositoryName is a helper method to define mock.On call
func (_e *MockDatabase_Expecter) GetDefaultRepositoryName() *MockDatabase_GetDefaultRepositoryName_Call {
	return &MockDatabase_GetDefaultRepositoryName_Call{Call: _e.mock.On("GetDefaultRepositoryName")}
}

func (_c *MockDatabase_GetDefaultRepositoryName_Call) Run(run func()) *MockDatabase_GetDefaultRepositoryName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockDatabase_GetDefaultRepositoryName_Call) Return(_a0 string) *MockDatabase_GetDefaultRepositoryName_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockDatabase_GetDefaultRepositoryName_Call) RunAndReturn(run func() string) *MockDatabase_GetDefaultRepositoryName_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetServiceCcrns provides a mock function with given fields: _a0
func (_m *MockDatabase) GetServiceCcrns(_a0 *entity.ServiceFilter) ([]string, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetServiceCcrns")
	}
...
// MockDatabase_GetServiceCcrns_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetServiceCcrns'
type MockDatabase_GetServiceCcrns_Call struct {
	*mock.Call
}

// GetServiceCcrns is a helper method to define mock.On call
//   - _a0 *entity.ServiceFilter
func (_e *MockDatabase_Expecter) GetServiceCcrns(_a0 interface{}) *MockDatabase_GetServiceCcrns_Call {
	return &MockDatabase_GetServiceCcrns_Call{Call: _e.mock.On("GetServiceCcrns", _a0)}
}

func (_c *MockDatabase_GetServiceCcrns_Call) Run(run func(_a0 *entity.ServiceFilter)) *MockDatabase_GetServiceCcrns_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*entity.ServiceFilter))
	})
	return _c
...
func (_c *MockDatabase_GetServiceCcrns_Call) Return(_a0 []string, _a1 error) *MockDatabase_GetServiceCcrns_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDatabase_GetServiceCcrns_Call) RunAndReturn(run func(*entity.ServiceFilter) ([]string, error)) *MockDatabase_GetServiceCcrns_Call {
	_c.Call.Return(run)
	return _c
}
