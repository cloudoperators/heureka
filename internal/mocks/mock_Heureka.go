...
// ListCcrns provides a mock function with given fields: filter, options
func (_m *MockHeureka) ListCcrns(filter *entity.ComponentInstanceFilter, options *entity.ListOptions) ([]string, error) {
	ret := _m.Called(filter, options)

	if len(ret) == 0 {
		panic("no return value specified for ListCcrns")
	}
...
// MockHeureka_ListCcrns_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListCcrns'
type MockHeureka_ListCcrns_Call struct {
	*mock.Call
}

// ListCcrns is a helper method to define mock.On call
//   - filter *entity.ComponentInstanceFilter
//   - options *entity.ListOptions
func (_e *MockHeureka_Expecter) ListCcrns(filter interface{}, options interface{}) *MockHeureka_ListCcrns_Call {
	return &MockHeureka_ListCcrns_Call{Call: _e.mock.On("ListCcrns", filter, options)}
}

func (_c *MockHeureka_ListCcrns_Call) Run(run func(filter *entity.ComponentInstanceFilter, options *entity.ListOptions)) *MockHeureka_ListCcrns_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockHeureka_ListCcrns_Call) Return(_a0 []string, _a1 error) *MockHeureka_ListCcrns_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHeureka_ListCcrns_Call) RunAndReturn(run func(*entity.ComponentInstanceFilter, *entity.ListOptions) ([]string, error)) *MockHeureka_ListCcrns_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListServiceCcrns provides a mock function with given fields: filter, options
func (_m *MockHeureka) ListServiceCcrns(filter *entity.ServiceFilter, options *entity.ListOptions) ([]string, error) {
	ret := _m.Called(filter, options)

	if len(ret) == 0 {
		panic("no return value specified for ListServiceCcrns")
	}
...
// MockHeureka_ListServiceCcrns_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListServiceCcrns'
type MockHeureka_ListServiceCcrns_Call struct {
	*mock.Call
}

// ListServiceCcrns is a helper method to define mock.On call
//   - filter *entity.ServiceFilter
//   - options *entity.ListOptions
func (_e *MockHeureka_Expecter) ListServiceCcrns(filter interface{}, options interface{}) *MockHeureka_ListServiceCcrns_Call {
	return &MockHeureka_ListServiceCcrns_Call{Call: _e.mock.On("ListServiceCcrns", filter, options)}
}

func (_c *MockHeureka_ListServiceCcrns_Call) Run(run func(filter *entity.ServiceFilter, options *entity.ListOptions)) *MockHeureka_ListServiceCcrns_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockHeureka_ListServiceCcrns_Call) Return(_a0 []string, _a1 error) *MockHeureka_ListServiceCcrns_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHeureka_ListServiceCcrns_Call) RunAndReturn(run func(*entity.ServiceFilter, *entity.ListOptions) ([]string, error)) *MockHeureka_ListServiceCcrns_Call {
	_c.Call.Return(run)
	return _c
}
