...
func (_m *MockHeureka) AddOwnerToService(_a0 int64, _a1 int64) (*entity.Service, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockHeureka) GetService(_a0 int64) (*entity.Service, error) {
	ret := _m.Called(_a0)
...
//   - _a0 int64
func (_e *MockHeureka_Expecter) GetService(_a0 interface{}) *MockHeureka_GetService_Call {
	return &MockHeureka_GetService_Call{Call: _e.mock.On("GetService", _a0)}
}

func (_c *MockHeureka_GetService_Call) Run(run func(_a0 int64)) *MockHeureka_GetService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
// ListUniqueUserID provides a mock function with given fields: _a0, _a1
func (_m *MockHeureka) ListUniqueUserID(_a0 *entity.UserFilter, _a1 *entity.ListOptions) ([]string, error) {
	ret := _m.Called(_a0, _a1)
...
// ListUniqueUserID is a helper method to define mock.On call
...
func (_c *MockHeureka_ListUniqueUserID_Call) Return(_a0 []string, _a1 error) *MockHeureka_ListUniqueUserID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHeureka_ListUniqueUserID_Call) RunAndReturn(run func(*entity.UserFilter, *entity.ListOptions) ([]string, error)) *MockHeureka_ListUniqueUserID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockHeureka) RemoveOwnerFromService(_a0 int64, _a1 int64) (*entity.Service, error) {
	ret := _m.Called(_a0, _a1)
