...
func (r *queryResolver) IssueMatchFilterValues(ctx context.Context) (*model.IssueMatchFilterValue, error) {
	return &model.IssueMatchFilterValue{
		Status: &model.FilterItem{
			...
			Values: lo.Map(
				model.AllIssueMatchStatusValuesOrdered,
				func(s model.IssueMatchStatusValues, _ int) *string { return pointer.String(s.String()) },
			),
		},
		IssueType: &model.FilterItem{
			...
			Values: lo.Map(
				model.AllIssueTypesOrdered,
				func(s model.IssueTypes, _ int) *string { return pointer.String(s.String()) },
			),
		},
		Severity: &model.FilterItem{
			...
			Values: lo.Map(
				model.AllSeverityValuesOrdered,
				func(s model.SeverityValues, _ int) *string { return pointer.String(s.String()) },
			),
		},
	}, nil
}
...
func (r *queryResolver) ComponentInstanceFilterValues(ctx context.Context) (*model.ComponentInstanceFilterValue, error) {
	return &model.ComponentInstanceFilterValue{
		Type: &model.FilterItem{
			...
			Values: lo.Map(
				model.AllComponentInstanceTypesOrdered,
